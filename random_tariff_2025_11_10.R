...
#Start Section 5: Ad-valorem tariffs, Figure 2####
...
#End Figure 2, end of Section 5####

#Start Section 6: Unilateral tariff (H only), just simulations, not in the paper####
...
#End Section 6: Unilateral tariff (H only), just simulations, not in the paper####
